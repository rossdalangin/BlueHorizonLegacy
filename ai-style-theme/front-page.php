...
?>
<section id="hero" class="section section-hero" style="padding-top: 180px; position: relative; <?php echo $hero_style; ?>">
    ...
    <div class="container">
        <div class="grid-two">
            ...
            <div style="font-size: 1.2rem; line-height: 1.8; opacity: 0.8;">
                <?php echo wp_kses_post( get_theme_mod('who_text', 'The AI Agency Group is a global AI infrastructure and implementation firm that builds AI departments and AI employees that replace work, reduce costs, and increase output across your business.') ); ?>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid-two">
            ...
            <div>
                ...
                <ul style="margin-top: 2rem; list-style: none; padding: 0; font-size: 1.1rem; opacity: 0.7;">
                    ...
                    <li style="margin-bottom: 1rem;">✦ Scaling AI inside your company without breaking operations</li>
                </ul>
...
<section class="section">
    <div class="container text-center">
        ...
        <div class="industry-grid">
            <?php
            $industries = explode(',', get_theme_mod('ind_list', 'Government, Solopreneurs, Insurance, Private Equity, M&A, Mining, Real Estate, Finance, Healthcare, Legal, E-Commerce, Technology, Speaking, Coaching, Trades, Small Business, Manufacturing, Corporate'));
            foreach ($industries as $industry) {
                echo '<span>' . esc_html(trim($industry)) . '</span> ';
            }
            ?>
        </div>
    </div>
...
<section id="services" class="section section-alt flat-border">
    <div class="container">
        ...
        <p style="margin-top: -1rem; margin-bottom: 4rem; opacity: 0.7; font-size: 1.2rem;"><?php echo wp_kses_post( get_theme_mod('serv_sub', 'We are relentlessly focused on one thing. Replacing inefficiency with intelligence and scaling your business without scaling your headcount.') ); ?></p>
...
<section id="partners" class="section">
    <div class="container">
        <div class="grid-two">
            <div>
                <h2 class="section-label"><?php echo esc_html( get_theme_mod('part_title', 'Build Your Own AI Agency.') ); ?></h2>
                <p style="margin-top: 2rem; opacity: 0.8; font-size: 1.1rem;"><?php echo wp_kses_post( get_theme_mod('part_sub', 'The AI Agency Group is not just a service. It is a platform. We give entrepreneurs, consultants, and business owners the infrastructure, training, and brand power to launch and operate their own AI agency.') ); ?></p>
            </div>
            <div>
                <div style="margin-bottom: 3rem; border-left: 2px solid var(--accent-teal); padding-left: 2rem;">
                    ...
                    <p>License our AI systems, training, and infrastructure under your own brand. You sell it. We build it. Full white label from day one.</p>
                </div>
                <div style="margin-bottom: 3rem; border-left: 2px solid var(--accent-teal); padding-left: 2rem;">
                    <h4 style="color: var(--accent-teal);">02 Direct Seller Partner</h4>
                    <p>Sell our AI services directly and earn recurring commissions. No build required. The simplest way to monetize your network with AI.</p>
                </div>
...
<section id="bio" class="section section-alt flat-border">
    <div class="container">
        <div class="grid-two">
            ...
            $bio_img_style = $bio_img ? "background-image: url('".esc_url($bio_img)."'); background-size: cover; background-position: center;" : "background: #050505;";
            ?>
            <div class="bio-visual flat-border" style="height: 600px; display: flex; align-items: center; justify-content: center; <?php echo $bio_img_style; ?>">
                <?php if (!$bio_img): ?>
                <div style="color: var(--accent-teal); text-align: center;">
                    <p style="font-size: 0.8rem; letter-spacing: 0.3em;"><?php echo esc_html( get_theme_mod('bio_label', 'Founding Managing Partner  |  One of 102 Global Partners') ); ?></p>
            ...
            <div>
                ...
                <div style="font-size: 1.15rem; line-height: 1.8; opacity: 0.8;">
                    ...
                    <p style="margin-top: 3rem; color: var(--accent-gold); font-size: 1.5rem; font-weight: 700; line-height: 1.2;">
