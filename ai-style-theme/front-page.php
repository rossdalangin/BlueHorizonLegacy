...
<section class="who-section section-alt" style="background-color: #000; color: #fff;">
    <div class="container">
        <div class="grid-two">
            <div>
                <h2 class="section-label" style="color: #fff; border-color: #fff;"><?php echo esc_html( get_theme_mod('div_title', 'Implementation + Training Division') ); ?></h2>
            </div>
            <div>
...
<section id="services" class="services-section">
    <div class="container">
        ...
        <p style="margin-bottom: 60px;"><?php echo wp_kses_post( get_theme_mod('serv_sub', 'We are relentlessly focused on one thing. Replacing inefficiency with intelligence and scaling your business without scaling your headcount.') ); ?></p>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <h3 style="font-family: var(--font-oswald); font-size: 1.5rem;"><?php echo esc_html( get_theme_mod("serv_t_$i", $serv_defaults[$i]['t']) ); ?></h3>
                <p style="text-transform: none; letter-spacing: 0; color: #fff; font-weight: 400; opacity: 0.6; font-size: 1rem;"><?php echo esc_html( get_theme_mod("serv_d_$i", $serv_defaults[$i]['d']) ); ?></p>
            </div>
            <?php endfor; ?>
        </div>
    </div>
...
<section id="partners" class="partner-section">
    <div class="container">
        ...
        <div class="who-text" style="margin-bottom: 60px;">
        ...
        <div class="dashboard-grid" style="border-color: rgba(0,0,0,0.1);">
            <?php
            ...
            for($p=1; $p<=4; $p++): ?>
            <div class="dashboard-card" style="border-color: rgba(0,0,0,0.1);">
                <div class="card-num" style="color: #000;"><?php echo str_pad($p, 2, '0', STR_PAD_LEFT); ?></div>
                <h3 style="font-family: var(--font-oswald); color: #000;"><?php echo esc_html(get_theme_mod("partner_t_$p", $partner_defaults[$p]['t'])); ?></h3>
                <p style="text-transform: none; letter-spacing: 0; color: #333; font-weight: 400; opacity: 0.8; font-size: 1rem;"><?php echo esc_html(get_theme_mod("partner_d_$p", $partner_defaults[$p]['d'])); ?></p>
            </div>
            <?php endfor; ?>
        </div>
...
<section class="partner-section" style="background-color: #fff;">
    <div class="container text-center">
        <h2 class="section-label" style="display: inline-block; color: #000;"><?php echo esc_html( get_theme_mod('scale_title', 'Every Level. Every Scale.') ); ?></h2>
...
<section id="bio" class="foxx-section">
    <div class="container">
        <div class="grid-two">
            ...
            <div>
                <h2 class="section-label" style="font-size: 51.2px;">Who Is JT Foxx</h2>
                <div class="who-text" style="color: #fff;">
                    ...
                    <p style="margin-top: 40px; color: var(--accent-gold); font-size: 1.8rem; font-weight: 800; line-height: 1.2; font-family: var(--font-oswald); text-transform: uppercase;">
...
<section class="proof-section">
    <div class="container">
        <h2 class="section-label text-center" style="display: block; margin: 0 auto 60px;"><?php echo esc_html( get_theme_mod('test_title', 'Real Businesses. Real Results.') ); ?></h2>
        <div class="dashboard-grid">
            <?php
            $test_defaults = array(
            ...
            <div class="dashboard-card" style="padding: 40px;">
                <p style="font-style: italic; color: #fff; opacity: 0.8; margin-bottom: 20px; font-size: 1.1rem; line-height: 1.6; text-transform: none; letter-spacing: 0;">"<?php echo wp_kses_post(get_theme_mod("test_q_$k", $test_defaults[$k]['q'])); ?>"</p>
                <h4 style="color: var(--accent-gold); font-size: 1rem; letter-spacing: 0.2em; font-family: var(--font-oswald);"><?php echo esc_html(get_theme_mod("test_n_$k", $test_defaults[$k]['n'])); ?></h4>
            </div>
            <?php endfor; ?>
        </div>
    </div>
...
<section class="section text-center" style="background-color: var(--primary-bg);">
    <div class="container">
        <h2 style="font-size: clamp(2.5rem, 6vw, 4.5rem); margin-bottom: 30px; line-height: 1; font-weight: 900;">
            <?php echo esc_html(get_theme_mod('cta_title', 'Ready to Work With Us?')); ?>
        </h2>
        <div class="who-text" style="max-width: 800px; margin: 0 auto 50px; color: #fff;">
